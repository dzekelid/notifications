...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/notifications/master/_listings/dropbox/apis.md
...
- name: Dropbox Notify Appendix API v1 - A long-poll endpoint to wait for changes
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/notifications/master/_listings/dropbox/longpoll-delta-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/notifications/master/_listings/dropbox/longpoll-delta-get-openapi.md
- name: Dropbox Notify Appendix API v1 - A long-poll endpoint to wait for changes
    on an account.
  x-api-slug: longpoll-delta-get
  description: |-
