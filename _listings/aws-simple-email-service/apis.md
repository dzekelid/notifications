...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/notifications/master/_listings/aws-simple-email-service/apis.md
...
- name: AWS Simple Email Service API - Set Identity Headers In Notifications Enabled
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/notifications/master/_listings/aws-simple-email-service/actionsetidentityheadersinnotificationsenabled-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/notifications/master/_listings/aws-simple-email-service/actionsetidentityheadersinnotificationsenabled-get-openapi.md
- name: AWS Simple Email Service API - Get Identity Notification Attributes
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/notifications/master/_listings/aws-simple-email-service/actiongetidentitynotificationattributes-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/notifications/master/_listings/aws-simple-email-service/actiongetidentitynotificationattributes-get-openapi.md
- name: AWS Simple Email Service API - Set Identity Headers In Notifications Enabled
  x-api-slug: actionsetidentityheadersinnotificationsenabled-get
  description: "Given an identity (an email address or a domain), sets whether Amazon
    SES includes \n            the original email headers in the Amazon Simple Notification
...
- name: AWS Simple Email Service API - Set Identity Notification Topic
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/notifications/master/_listings/aws-simple-email-service/actionsetidentitynotificationtopic-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/notifications/master/_listings/aws-simple-email-service/actionsetidentitynotificationtopic-get-openapi.md
- name: AWS Simple Email Service API - Get Identity Notification Attributes
  x-api-slug: actiongetidentitynotificationattributes-get
  description: Given a list of verified identities (email addresses and/or domains),
    returns a structure describing identity notification attributes.
