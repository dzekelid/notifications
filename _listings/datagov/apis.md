...
- name: Data.gov API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/notifications/master/_listings/datagov/notifications-get.md
- name: Data.gov API Get Notifications
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/notifications/master/_listings/datagov/notifications-get-postman.md
x-common:
- type: x-blog
