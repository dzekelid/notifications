...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/notifications/master/_listings/google-apps-admin-sdk/apis.md
...
- name: Google Apps Admin SDK Merged API - Get Watch Details
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/notifications/master/_listings/google-apps-admin-sdk/resellernotifygetwatchdetails-get-openapi.md
- name: Google Apps Admin SDK Merged API - Get Watch Details
  x-api-slug: resellernotifygetwatchdetails-get
  description: Returns all the details of the watch corresponding to the reseller.
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/nexusae0_icon2.png
