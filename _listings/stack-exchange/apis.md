...
- name: Stack Exchange Get User Notifications Unread
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/notifications/master/_listings/stack-exchange/users-id-notifications-unread-get.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/notifications/master/_listings/stack-exchange/users-id-notifications-unread-get-postman.md
x-common:
